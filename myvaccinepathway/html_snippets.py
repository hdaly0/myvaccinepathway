...
<ul>
  ...
  <li>Some dose 2 data, and some booster jab data, was extrapolated based on patterns in the data that were available. For full details see comments in the code on github</li>
  ...
  <li>No Moderna data was available for omincron so Pfizer data is used in its place. As above, this is should be a reasonable lower bound for Moderna vaccinated individuals.</li>
</ul>
<hr>
"""

# TODO: Add data warnings (e.g. moderna data not available)
MODERNA_DATA_WARNING = """
